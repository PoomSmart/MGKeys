...
static const struct tKeyMapping keyMappingTable[] = {
    ...
    "+VTSncKV5ykgl9KAsuHFFg", "security-domain", // non-gestalt-key
    "+xJ6RaQ6PDSsLjib8r5fgg", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with p, DeviceSupportsCameraCaptureOnTouchDown
    "/2V8H9h/+z0UxNUr9aRLeQ", "boot-nonce", // non-gestalt-key
    ...
    "/wG6EG34fRtAsZoLk/8YIw", "supports-autodim", // non-gestalt-key
    "/YYygAofPDbhrwToVsXdeA", "HWModelStr",
    "/ZdBovdn5DLfkQkSAuAskw", "supports-side-btn-click-speed", // non-gestalt-key
    ...
    "0/QVFV5/X0h5iDjrdYYcog", "product-soc-name", // non-gestalt-key
    ...
    "0gkWjKWKuS2gqzTaFHKxqw", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, DeviceSupportsAdvancedVoiceProcessorChatFlavor
    ...
    "0vvGMT0ltmG03nFfaXxoHg", "supports-pearl-motion-detection", // non-gestalt-key
    ...
    "1HWDBfJwBJZ8TDHcPDafmQ", NULL, // non-gestalt-key, IODeviceTree:/product, starts with e, DeviceHasEmbeddedSIMOnlyBoard
    ...
    "1oUugT++JJx5gOVyB2la7w", "siri-hub", // non-gestalt-key
    ...
    "2aIAScwtFNCz+Y7WesMOCA", NULL, // non-gestalt-key, IODeviceTree:/product, starts with m, SecondaryWifiMacAddressData
    "2IDxmg5KyAMBBi/b0rojgQ", "telephony-maximum-generation",
    "2kuITg6XPwXl8zbpx+hoCw", "FrontFacingIRCameraModuleSerialNumber",
    "2lNKobEIQqX50ohy1JBqCA", "no-hi-res-buildings", // non-gestalt-key
    ...
    "2v9hQi8xVAKZZVCMd/YhjQ", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, DeviceSupportsSiriBargeIn
    "2ViNo1fbaEkg2vdTmCiW7g", "partially-occluded-display", // non-gestalt-key
    ...
    "3hD7TZt4FFvCgra7E8PkWw", "cycling-auto-reminders", // non-gestalt-key
    "3Hj0jFscGt094g65Fag7eQ", "t7001\")", // non-gestalt-key
    "3kmXfug8VcxLI5yEmsqQKw", "InDiagnosticsMode",
    "3m1Q0AXlqeA2C/LmqdTndQ", "HasDaliMode",
    "3sF/uRq+X+mZ2zGHSJOwpw", "crypto-hash-method", // non-gestalt-key
    "3uw7204ET4Vk1Cl4iJiNqQ", "ttw-supported", // non-gestalt-key
    "3yzXj0lJhQi+r3kgQlwiOg", "FrontFacingCameraVideoCapture1080pMaxFPS",
    "4+ntrbAfaq8rQKPfQo16CQ", "supports-oyster", // non-gestalt-key
    ...
    "4eFYRO4KDf8py/Zf3iHWZw", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, SpeakerCalibrationSpTs
    ...
    "4k6Wv56SWfITjzet+hIHMQ", "multi-touch", // non-gestalt-key
    "4OThI5F+/uP2oXUpdDxGnw", "supports-burnin-mitigation", // non-gestalt-key
    ...
    "5/NbwB1egBxY8gECPU4nPA", "housing-color", // non-gestalt-key
    ...
    "5dyhCh3dm1vSOaNK+US1Qw", "euicc-chip-id", // non-gestalt-key
    "5hfTRTYOuOthOyRny6a38w", "continuity-camera",
    "5iilxso47rYJZGnXklkYYg", "framebuffer-identifier", // non-gestalt-key
    ...
    "6PkKE66MnKm0yiOIQLknEg", "allow-32bit-apps", // non-gestalt-key
    ...
    "6Y9R9JVBWd2wTX5ZdDGsWA", "absolute-depth-limit", // non-gestalt-key
    ...
    "7ot70MKj7EdRIEEi91jlcg", "bitrate-3g", // non-gestalt-key
    "7pq6UGJM2TaOP2brCspvyA", "acoustic-id", // non-gestalt-key
    "7qHcAWI5X9b1SiyYIg/Byw", "ui-background-quality", // non-gestalt-key
    ...
    "7zSkleuS91WkyAuEEH7p2g", "sw-pro-res", // non-gestalt-key
    ...
    "86GizkmSK+IxgCtUMOp2NA", "front-max-video-fps-720p", // non-gestalt-key
    ...
    "8Kc1MRjWTfDiGKX6E/9XqQ", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with l, DeviceSupportsLongFormAudio
    "8kcKPCGGyCpf66MMl5TVkA", NULL, // non-gestalt-key, IODeviceTree:/multi-touch, starts with m, MultiTouchMaxBootTime
    ...
    "9Bp5z20HsA1f7dqvelXKXA", "supports-maps-optical-heading", // non-gestalt-key
    "9f5ODNAt2gufqSI82eYnLw", NULL, // non-gestalt-key, IODeviceTree:/multi-touch, starts with c, DeviceSupportsCorrectedTemperature
    ...
    "Ah5yfSlY2yycIQb92HbmrA", "function-button_ringerab", // non-gestalt-key
    ...
    "aL9+NE29t3Wm2lEAE+atZQ", "vaxholm", // non-gestalt-key
    "aNFMPe3XMOjAHDzk1h0eeA", "eos-halley-config", // non-gestalt-key
    "aNZeCyuWxI6SE/KwZ129wA", "name", // non-gestalt-key
    ...
    "brr2lQq9584zVkiuALaADA", "scandium", // non-gestalt-key
    ...
    "bxQyyA/qJ3QQXTiHBsW2eg", NULL, // non-gestalt-key, IODeviceTree:/product, starts with o, BuddyLanguagesAnimationRequiresOptimization
    "byGRtH44VNik9CzN/QKLCw", "nfc",
    "bysMryc4yLwQjKvUQGGXXQ", "DevicePrefersProceduralAntiAliasing",
    "BYYil6kIk8Hm5lRuA1k8Tw", "prox-sensor", // non-gestalt-key
    "c2ZyLSF00uEyREloINiqVA", "high-bandwidth-radio", // non-gestalt-key
    ...
    "cganRwxlDnONJx4WeDI0kQ", "firmware-version", // non-gestalt-key
    "ch7KBY7aSsznfICVzjFldw", "external-hdr", // non-gestalt-key
    ...
    "cmkS/KVB6ubxH76sLbumbw", "rear-max-slomo-video-fps-1080p", // non-gestalt-key
    ...
    "cq/jTAQ8zJab+ibcGUzJew", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with m, DeviceSupportsBeacon
    ...
    "D3LeXyjrxDFYSi6pWFEL4A", NULL, // non-gestalt-key, IODeviceTree:/product, starts with u, DeviceSupportsTrafficAlpha
    "D4AU4tOIuGKN3G/uix65cQ", "RegionalBehaviorAll",
    "D6/BMDrlb8V3WSiqL8gL+w", "DeviceSupportsBatteryModuleAuthentication",
    "D6PT05dEJ0f9Ayk7Yi92RA", "front-max-video-fps-1080p", // non-gestalt-key
    "dbYxhQWXkJhjp8uPhoMDvw", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with p, DeviceSupportsPortraitIntensityAdjustments
    "DcQNvnO5Uhpc1jjGIrzyng", "BatterySerialNumber",
    "DCy89X5oErFAps95GX38mQ", "live-photo-auto", // non-gestalt-key
    ...
    "DIXX7JMbm7glu49f+xi4zQ", "live-effects", // non-gestalt-key
    ...
    "dUipfYkyvM80t4IkmMBVgQ", NULL, // non-gestalt-key, IODeviceTree:/product, starts with w, DeviceSupportsElton
    "DViRIxZ/ZwO007CLcEYvZw", "SoftwareBundleVersion",
    "dW6ROVcD3o5ACa4jvALJ6A", NULL, // non-gestalt-key, IODeviceTree:/product, starts with d, DynamicFunctionRowSerialNumber
    ...
    "e9aZViEIJ/riA4pRfg1ihg", "device-color-policy", // non-gestalt-key
    ...
    "EuGnCiDhD1LBnMc96k/GQQ", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, SpeakerCalibrationSpGa
    ...
    "Fam17Ufz3CiHdZPcma0AeQ", "regulatory-model-number", // non-gestalt-key
    "fb+1apeTeouqt+fo3nZ6sg", NULL, // non-gestalt-key, IODeviceTree:/product, starts with u, MedusaOverlayAppCapability
    ...
    "FQHZ8VqG8mVzDQ+g085l8w", "target-sub-type", // non-gestalt-key
    ...
    "FuR7SfqQmxpRW5MyqMm7FQ", "low-power-wallet-mode", // non-gestalt-key
    "fv8ZXM/NhUHQBQqCSk19cA", "FrontFacingCameraAutoHDRCapability",
    "fW9C1U4C1FR8bwe1VqEWug", "full-6",
    "fxnMXVRwuznDzWhoDCxb2A", "oled-display", // non-gestalt-key
    ...
    "g1gP4TOlkv84ezeaZrUgFg", "thin-bezel", // non-gestalt-key
    ...
    "gJ3kBkjdqJ04oSsOmC97aw", "partition-style", // non-gestalt-key
    ...
    "GnhnHyRVCC8LUClgElhKXA", "effective-security-mode-ap", // non-gestalt-key
    ...
    "H4f1y1sEDUUUROeb4FZJ4A", NULL, // non-gestalt-key, IODeviceTree:/product, starts with n, RequiresNaturalVolumeButtonArrangement
    ...
    "h9v96tCehBWUil/aJ7UrcA", NULL, // non-gestalt-key, IODeviceTree:/product, starts with u, MedusaPinnedAppCapability
    ...
    "hh/NoWpEoq1VF4lGDdPUpw", "role", // non-gestalt-key
    "HHF6YgqEQ9Kd7MBSVnLsgg", "DeviceSupportsAOP",
    "HhLXszMhK6bb9TP4sqVQWQ", NULL, // non-gestalt-key, IODeviceTree:/chosen, starts with e, ExtendedSecurityDomain
    "hhRNi2d3z2WEFmU+xG/EXw", "ActuatorResonantFrequency",
    "HIaq6xVZ/V8B9pnigcvqCA", "DeviceSupports3DMaps",
    "hiHut/WR+B9Lx/vd0WyeNg", "wapi",
    "hK/qlAUuu8u6SvIRkKmjQQ", "gps-capable", // non-gestalt-key
    ...
    "hRBbURJnULvXsPGk42A8Ng", "supports-avatars", // non-gestalt-key
    ...
    "I6rd1SCXpRqBMDTPBbcWzA", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with m, SpeakerCalibrationMiGa
    "i6wlxJoKNXBiVXJHJ1EHBg", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, DeviceSupportsStereoAudioRecording
    ...
    "iifCuJmggYlB4hLzc0Zoiw", "rear-max-slomo-video-fps-720p", // non-gestalt-key
    ...
    "is3zjHrEdiF6J/boqghy9A", NULL, // non-gestalt-key, IODeviceTree:/product, starts with m, PintoMacAddressData
    "ItOvlwIhFj2aCXL4wk3ijg", "front-single-camera-portrait", // non-gestalt-key
    "iTvGxmtSOnHv548XON379A", "DeviceMesaType",
    "IUvPFaILUl3l0684dR0AlA", "front-max-video-zoom", // non-gestalt-key
    "IvdL59ITgJvhb5ptpLbqRg", "rear-focus-pixel-calibration", // non-gestalt-key
    ...
    "jkRyJt34tZOjsO1YhVc0mw", NULL, // non-gestalt-key, IODeviceTree:/product/audio, starts with s, AutomaticMicMode
    "JkZlE8z9YwHjE1hnbMhcgA", "DeviceSupportsHDRDeferredProcessing",
    "JljZ8PqQJB8QlFC2NsgOPw", NULL, // non-gestalt-key, IODeviceTree:/product, starts with e, WorkoutUltraMode
    ...
    "K0tZN4PayAx7RgB0M+oohw", "bitrate-lte", // non-gestalt-key
    ...
    "kc+QzHP4Frf2NvP+mclQ2A", "wifi-chipset", // non-gestalt-key
    "KFwMMyiMoa8pLgGLwo78Vw", NULL, // non-gestalt-key, IODeviceTree:/product, starts with h, DeviceSupportsAppleLPM
    ...
    "KN7t4gQkyj5X66dBpmh9HQ", "large-format-phone", // non-gestalt-key
    "knoZzQDWpu6OQWS7wgRWLg", "rear-max-video-zoom", // non-gestalt-key
    "Knrkxkj5zZTf/FrPNQClgg", "GroundhogEnabled",
    "kQ8nm82jb5iTBUwT2M3aIQ", NULL, // non-gestalt-key, IODeviceTree:/chosen, starts with m, SecondaryEthernetMacAddressData
    ...
    "KWr9OM2iqeLQEhaHS0UshQ", NULL, // non-gestalt-key, IODeviceTree:/arm-io/i2c0/audio0, starts with a, DeviceSupportsLineIn
    ...
    "l1MfXa14uBR9cvO8D9wc9w", NULL, // non-gestalt-key, IODeviceTree:/product, starts with u, MedusaFloatingLiveAppCapability
    ...
    "ldJQht23DQY8SUXKJhUvPw", NULL, // non-gestalt-key, IODeviceTree:/backlight, starts with u, DeviceSupportsFrameSynchronousBrightness
    "LDmYwbIay7HexqftCTLDNg", "reverse-zoom-supported", // non-gestalt-key
    ...
    "lFFadhW8h/hfpcu601hyqg", NULL, // non-gestalt-key, IODeviceTree:/, starts with h, DeviceSupportsInductiveCharging
    "Lg1EJX11Jb7EbveB6+YgVQ", "720p",
    "lHMDJnC58naUz2rOCJyVIw", "IntegratedCircuitCardIdentifier2",
    "li+w2foswFu0srn5UxdOug", "arm64e",
    "lICl1+LV8GYEzQPilmyIXg", "rear-variable-frame-rate", // non-gestalt-key
    "LJ8aZhTg8lXUeVxHzT+hMw", "TimeSyncCapability",
    "LkWb+FyA1+ef2UD1Fx+kAw", "RearFacingCameraHDROnCapability",
    "LL1FDn5UwIi7sIDnL19gxA", "bluetooth-lea2", // non-gestalt-key
    "lMKshPs7fX9YxDSOEXnoiw", "effective-security-mode-sep", // non-gestalt-key
    "LMvmpCFM38ZaFeEy4r7nNQ", "camera-hdr-version", // non-gestalt-key
    "lNtvJFI6kdcchIbskQDzaA", "backlight", // non-gestalt-key
    ...
    "LWxSM4CmFZMwzYclSh43gg", "rear-hdr", // non-gestalt-key
    "LXP9TbNYtZrIKOktGXez2Q", "3d-maps", // non-gestalt-key
    "lY6RKv6ri6kfBeJCWilmmQ", "front-burst-image-duration", // non-gestalt-key
    ...
    "MfLtAGqrSIJgBHzuir/DoA", "coverglass-serial-number", // non-gestalt-key
    ...
    "mH5IrpyGkVtmgdqs68KHRg", "gyro", // non-gestalt-key
    "Mi/ME+v1wZqkvXFU3xX3KA", "iphone-ipad-minimum-performance-a12",
    "Mif7940cFpfaXIAHwkYgHQ", "power-control-features", // non-gestalt-key
    ...
    "mug/QuG6jZ3CYR9p7OWQaw", NULL, // non-gestalt-key, IODeviceTree:/opal, starts with b
    ...
    "npI2l0ybDY9Um4z/T8K/Sg", "deferred-processing", // non-gestalt-key
    ...
    "OCKVZEIuMz4sxhLz7vmQ5w", "spatial-over-capture", // non-gestalt-key
    ...
    "oxH8p7+EaUzhkc2edrXsQQ", "aggregate-cam-photo-zoom", // non-gestalt-key
    "OyENNqRhuo8+RHkpbr/82A", "RoswellChipID",
    "oYicEKzVTz4/CxxE05pEgQ", "TargetSubType",
    "P+UqVuzQzn3nwHSiSeDmyw", "live-photo-capture", // non-gestalt-key
    "P1djMN/L3B6otgGpO9WYkw", NULL, // non-gestalt-key, IODeviceTree:/, starts with s, SiliconBringupBoard
    "P1uSdgM/fIttMsA/+q6k4w", "watch-keyboard", // non-gestalt-key
    ...
    "pdFo85PUvIiT4FjAT6Amcw", "baseband-chipset", // non-gestalt-key
    ...
    "PgQhOQ4/ZYPLM6mgAoPm4A", "absolute-depth", // non-gestalt-key
    ...
    "PNIwPfoxY6URyv3kSma5Aw", "wifi-antenna-sku-info", // non-gestalt-key
    ...
    "PT6XKHaOkrxhQTpTVI8Rlw", "supports-secure-microphone", // non-gestalt-key
    ...
    "pxqIJ789zCoOILWO6cQ52Q", "no-simplistic-road-mesh", // non-gestalt-key
    "Q/BI7GKNZY13TpxbqA8nhQ", "rear-max-video-fps-720p", // non-gestalt-key
    "Q1Ty5w8gxMWHx3p4lQ1fhA", "MLBSerialNumber",
    "Q2jR+AUT9PTHUrP/mkdfxQ", "NVRAMDictionary",
    "Q2y7EshBFzIifIPKAPVBBA", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with c, CameraAppUIVersion
    ...
    "qAAQUPLjf+Hl4UM3WY2qgw", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with f, FrontFacingCameraHFRVideoCapture720pMaxFPS
    "qb//mYg6KeTmjv8w4ZAMIg", "CompassCalibration",
    "QbQzuIbef01P4JeoL9EmKg", "DeviceSceneUpdateTimeLimitScale",
    "QD3Nde07fjdK0R0KTbczEA", "board-revision", // non-gestalt-key
    ...
    "Qt+S0J/SXrcfymyfJWvCCQ", "rosaline-serial-num", // non-gestalt-key
    ...
    "QY61T8CLLwG/yu92ScTYtw", NULL, // non-gestalt-key, IODeviceTree:/product, starts with s, driverkit
    "QZgogo2DypSAZfkRW4dP/A", "InternationalMobileEquipmentIdentity",
    "qzHhHrOpIDLAq2balBdVZg", "RingerButtonCGRect",
    "r/++Z94rbTcHrTtZ/rCU4w", "s8000\")", // non-gestalt-key
    "R1AF5xVFhlNjSbjBZJqQeA", "rear-stage-light-portrait", // non-gestalt-key
    "R1tbjTooZCgq2KmzlTaX+g", "front-stage-light-portrait", // non-gestalt-key
    ...
    "RaX3KBmG7H9fUOEtLK/I6w", "stockholm", // non-gestalt-key
    ...
    "RIJvT6s+kyJKsCvHFbcwwA", "has-boot-chime", // non-gestalt-key
    ...
    "RN/FxX/3jy6LWaEIPR8qpA", "collision-sos", // non-gestalt-key
    "RN4AimpWqqD2JZCB67qtvQ", "carplay-2", // non-gestalt-key
    ...
    "SIC/2YcTF6ydv8Hfcn9THw", NULL, // non-gestalt-key, IODeviceTree:/arm-io/aop/iop-aop-nub/als, starts with a, DisplayInactiveBrightnessClass
    ...
    "SKBEzVsOS9Wr/WlkVtlUMQ", "front-variable-frame-rate", // non-gestalt-key
    "sLe8lqXRlqZM74MNUoVcyQ", "BatteryIsCharging",
    "SLu4aVo/V1CulJ7eyTDh1w", NULL, // non-gestalt-key, IODeviceTree:/product, starts with e, DeviceSupportsEnvironmentalDosimetry
    "SMgTCc2v9AU2ziIHRX8qww", "hearingaid-audio-equalization",
    "smT9LjRW3acTT7WTS/XqyQ", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with f, FrontFacingCameraHFRVideoCapture1080pMaxFPS
    ...
    "Sr1Bmb3uoIfgKyaZguG0Gw", "front-max-video-fps-4k", // non-gestalt-key
    ...
    "sYxZdpH3i8nwjZNet0QuAw", "fcm-type", // non-gestalt-key
    "SZy8T5ma/+a0wJc0ntiaaA", "PhoneNumber2",
    "T0FD6BT+PiWc2duMVlTRww", "DeviceIsPortableMac",
    "t56wS9db+T2F2bxBpYSX8Q", NULL, // non-gestalt-key, IODeviceTree:/arm-io/disp0, starts with e, DisplayDriverICChipID
    "TACCxk6y28d14yJN09RtTg", "DeviceSupportsLanguageDownloadUI",
    "tad3RCjcWdkyLSVI8kUBtA", "caller-id",
    "tAryHM5IUMkdtvVqqu1tcA", "ambient-light-sensor-serial-num", // non-gestalt-key
    ...
    "tOLVnZop4m/g5/iuC7zlUw", "effective-production-status-ap", // non-gestalt-key
    ...
    "U1fcnNYCEu9uH1bg3/6PKQ", "image4-supported", // non-gestalt-key
    ...
    "UF3CoK9RCYXfTyzttoxNDQ", "enc-top-type", // non-gestalt-key
    ...
    "uNNFSosc1xQM/7bwlrqLXA", NULL, // non-gestalt-key, IODeviceTree:/arm-io/aop/iop-aop-nub/als, starts with m, DisplayMaxNits
    "uO3aPe7lfB1XxSiz/1xBvA", "CertificateProductionStatus",
    "UoeNJcQ336tc+F5/1r4tqQ", "DeviceSupportsAdvancedMapRendering",
    "us1armjE6TKGvh2WIrNgEQ", NULL, // non-gestalt-key, IODeviceTree:/defaults, starts with a, AlwaysOnDisplayMaxMemory
    "uyejyEdaxNWSRQQwHmXz1A", "DiskUsage",
    "UYZtXbMcIyMRZQ9pjDxRvA", "ui-weather-quality", // non-gestalt-key
    "UZfUiD1Aqy3GOwg72SQcLQ", "RearFacingSuperWideCameraModuleSerialNumber",
    "UZyrJHlX635ocWEjBkt9YA", "UIProceduralWallpaperCapability",
    "v/BP9Nx/zfo9bKi9JR2p+g", "3d-imagery", // non-gestalt-key
    "V0d6pv080gHL3QQWNs9aog", "DeviceSupportsLowPowerSoundClassification",
    "v1/EHDarbU55OfoXm2EiGA", "supports-on-device-siri", // non-gestalt-key
    "v2Q3tLoD4+o/XazHC/0FyA", "DeviceSupportsYCbCr10",
    "V2Ykm/0M3CA6nyNhwNInsg", "64-bit",
    "v5YVEwERRin1v+reUNjJ5w", "ComputerName",
    "v7h4TrJdmukTl8gpzVl3DQ", "grimaldi", // non-gestalt-key
    ...
    "vmZuX/fdqt3gKhonHYLyUw", "aggregate-cam-video-zoom", // non-gestalt-key
    "voS/bmBAz0Y1eNLoN8x9/Q", NULL, // non-gestalt-key, IODeviceTree:/product/camera, starts with p, front-depth-camera
    "vq2wpvLzyYLEApQs9cs52A", "panel-serial-number", // non-gestalt-key
    ...
    "wAbB2fAjUqUc6lNBelfWMA", NULL, // non-gestalt-key, IODeviceTree:/product, starts with n, DeviceSupportsPeriodicALSUpdates
    ...
    "WbcphnnzI6Yb5r/AzwiyUA", "mix-n-match-prevention-status", // non-gestalt-key
    ...
    "X9NA3D+PguwY0i0Uffl07Q", "camera-rear", // non-gestalt-key
    ...
    "xgs6iXf0KFHUJ9d4FKaRYg", NULL, // non-gestalt-key, IODeviceTree:/product, starts with s, DeviceSupportsGrey
    ...
    "XKpK5v7PGzbe7igjloNBpQ", "closed-loop", // non-gestalt-key
    ...
    "xXBT4e92qXwQo3SYmACj3w", "die-id", // non-gestalt-key
    "XxnEk9uiIk5vCdbWEGt7lA", "DeviceSupportsLiquidDetection_CorrosionMitigation",
    "XYlJKKkj2hztRP1NWWnhlw", "ResearchFuse",
    "XyppJjhSQE2982ZYgXlh2g", "supports-nfc-reader-mode", // non-gestalt-key
    ...
    "y66yh6E28lG6AIdLLwEvSQ", "disp0", // non-gestalt-key
    "YAbRmHobt+BRHuSPm2OGQw", "DeviceSupportsVirtualResearchEnvironment",
    "ybGkijAwLTwevankfVzsDQ", "MainScreenCanvasSizes",
    "YcNAX0Gc6KejQPKSrA9kvg", "front-burst", // non-gestalt-key
    "YdPNjYPBzyE0jJl2X/CayQ", "RotateToWakeStatus",
    "yeaE9+OrN2WJlWkDroMtZg", "bitrate-wifi", // non-gestalt-key
    "yeQy+rgNoD7+YIY6mSVOhg", NULL, // non-gestalt-key, IODeviceTree:/opal, starts with e
    ...
    "yhZxZlqgBWwf4bN9t6fFyA", "always-on-time", // non-gestalt-key
    ...
    "yPSUYPhrVLHnvX0TUugiwg", "rear-auto-hdr", // non-gestalt-key
    ...
    "ZcPQWuQwUJtMR5Oj99uc8w", "supports-twilight", // non-gestalt-key
    "zDBaE8nqtDP8hY4pOa6iMw", "t7000\")", // non-gestalt-key
    ...
    "znvmheFkjr6hiqIK9TrCVw", "pressure", // non-gestalt-key
