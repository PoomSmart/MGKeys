...
static const struct tKeyMapping keyMappingTable[] = {
    ...
    "+xJ6RaQ6PDSsLjib8r5fgg", "photo-capture-on-touch-down", // non-gestalt-key
    ...
    "2v9hQi8xVAKZZVCMd/YhjQ", "supports-barge-in", // non-gestalt-key
    ...
    "4vrSNeBZwJrQrZOQJG0uwQ", "supports-camera-button", // non-gestalt-key
    ...
    "8Kc1MRjWTfDiGKX6E/9XqQ", "long-form-audio-play", // non-gestalt-key
    ...
    "cq/jTAQ8zJab+ibcGUzJew", "mandrake-supported", // non-gestalt-key
    ...
    "dbYxhQWXkJhjp8uPhoMDvw", "portrait-lighting-strength", // non-gestalt-key
    ...
    "dUipfYkyvM80t4IkmMBVgQ", "watch-gestures", // non-gestalt-key
    "DViRIxZ/ZwO007CLcEYvZw", "SoftwareBundleVersion",
    "dW5fpt/6HhaTbnK/UqL6cA", NULL,
    ...
    "EuGnCiDhD1LBnMc96k/GQQ", "speaker-trim-gains", // non-gestalt-key
    ...
    "fb+1apeTeouqt+fo3nZ6sg", "ui-overlay-app", // non-gestalt-key
    ...
    "h1UG2n5HnANzU4rX8pT85g", NULL,
    "H4f1y1sEDUUUROeb4FZJ4A", "natural-volume-arrangement", // non-gestalt-key
    ...
    "I6rd1SCXpRqBMDTPBbcWzA", "mic-trim-gains", // non-gestalt-key
    "i6wlxJoKNXBiVXJHJ1EHBg", "stereo-sound-recording", // non-gestalt-key
    ...
    "jkRyJt34tZOjsO1YhVc0mw", "supports-auto-mic-mode", // non-gestalt-key
    "JkZlE8z9YwHjE1hnbMhcgA", "DeviceSupportsHDRDeferredProcessing",
    "JljZ8PqQJB8QlFC2NsgOPw", "extended-workout", // non-gestalt-key
    ...
    "KFwMMyiMoa8pLgGLwo78Vw", "has-applelpm", // non-gestalt-key
    ...
    "kQ8nm82jb5iTBUwT2M3aIQ", "mac-address-ethernet1", // non-gestalt-key
    ...
    "ldJQht23DQY8SUXKJhUvPw", "use-syncdbv", // non-gestalt-key
    ...
    "oQNDePXjSD1z7W0ddqt9tg", NULL,
    "OtnrTIhWBtyPo45BcApMTw", "supports-3rd-party-haptics", // non-gestalt-key
    ...
    "Q2y7EshBFzIifIPKAPVBBA", "camera-ui-version", // non-gestalt-key
    ...
    "qAAQUPLjf+Hl4UM3WY2qgw", "front-max-slomo-video-fps-720p", // non-gestalt-key
    ...
    "QY61T8CLLwG/yu92ScTYtw", "supports-third-party-drivers", // non-gestalt-key
    ...
    "SIC/2YcTF6ydv8Hfcn9THw", "aot-class", // non-gestalt-key
    ...
    "SLu4aVo/V1CulJ7eyTDh1w", "env-audio-exp-capable", // non-gestalt-key
    "SMgTCc2v9AU2ziIHRX8qww", "hearingaid-audio-equalization",
    "smT9LjRW3acTT7WTS/XqyQ", "front-max-slomo-video-fps-1080p", // non-gestalt-key
    ...
    "us1armjE6TKGvh2WIrNgEQ", "aod-max-mem", // non-gestalt-key
    ...
    "voS/bmBAz0Y1eNLoN8x9/Q", "pearl-camera", // non-gestalt-key
    "vq2wpvLzyYLEApQs9cs52A", "panel-serial-number", // non-gestalt-key
    "vQg8hRTy1PC2j9L+8Jd+vg", "supports-voiceover-can-use-siri", // non-gestalt-key
    ...
    "Wft7kODl9Y2uX/sb47GoEA", "supports-aod-vibrancy", // non-gestalt-key
    ...
    "xgs6iXf0KFHUJ9d4FKaRYg", "supports-grey-gestures", // non-gestalt-key
    ...
    "yeQy+rgNoD7+YIY6mSVOhg", "enc-bot-type", // non-gestalt-key
