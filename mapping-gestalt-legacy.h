...
static const struct tKeyMapping keyMappingTableLegacy[] = {
    "+zD41v0XRR72ItZHfisZuQ", "PTPLargeFilesCapability", // iOS 8.4+ (removed in 14.3)
    "/8aKho3RQEvq1PxPnN2ziQ", "MetalCapability",
    "04zgp3uYWXAEZCOV0wrVXQ", "hardware-detents", // iOS 13.7+ (removed in 14.3)
    ...
    "A8aFtN08Oqt21846jqnftQ", "SiriGestureCapability", // iOS 8.4+ (removed in 14.3)
    ...
    "drPpRw0Jmqcxv1XQPn/q/Q", "CameraFrontFlashCapability", // iOS 9.3+ (removed in 14.3)
    "dvaktw5A/h0zlsWpMg/COQ", "DeviceSupports64Bit",
    "dZ2183tXAlFrXRtDcdiqJQ", "Peer2PeerCapability",
    "E2iZGHvwvi387UKi9wC2Mg", "CameraFlashCapability", // iOS 8.4+ (removed in 14.3)
    "Ecx7M8v2wk05Fch3pFE/GA", "NikeIpodCapability", // iOS 8.4+ (removed in 14.3)
    ...
    "htWSrEg/cfn3squdzvER/w", "MLEHW", // iOS 9.3+ (removed in 14.3)
    "hVVttq0KhS190K5SkaajpQ", "FrontFacingCameraCapability",
    "I2IvpG8yJdNpvO4csuB9EA", "LocationRemindersCapability", // iOS 8.4+ (removed in 14.3)
    ...
    "jyEyRLza0L3StNXgFUCoTw", "GPSCapability", // iOS 12.0+ (removed in 14.3)
    ...
    "lM8BH5myz/qFGeIYnsiEoQ", "HearingAidAudioEqualizationCapability", // iOS 8.4+ (removed in 14.3)
    ...
    "v5AoJC7hPGHbysTMLip12A", "SupportsTapToWake", // iOS 13.7+ (removed in 14.3)
    ...
    "XACgWnmwo1t6swUPu+/UUQ", "AutoFocusCameraCapability", // iOS 8.4+ (removed in 14.3)
    ...
    "YH5LeF090QGZQTvT76qcBg", "HearingAidPowerReductionCapability", // iOS 8.4+ (removed in 14.3)
