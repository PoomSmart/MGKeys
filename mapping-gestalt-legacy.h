...
// Total: 168 keys
// Deobfuscated: 163 keys (97.02%)
// Unexplored: 5 keys

static const struct tKeyMapping keyMappingTableLegacy[] = {
    "+zD41v0XRR72ItZHfisZuQ", "PTPLargeFilesCapability", // iOS 8.4–14.3
    "/8aKho3RQEvq1PxPnN2ziQ", "MetalCapability",
    "04zgp3uYWXAEZCOV0wrVXQ", "hardware-detents", // iOS 13.7–14.3
    ...
    "1tvy6WfYKVGumYi6Y8E5Og", "AccelerometerCapability", // iOS 17.0–26.0
    "1ZJLuPSZ7T410f25nyus0g", "BluetoothLECapability",
    "2RMKoChpU7jtotAG7NYV4Q", "VOIPCapability",
    "3lh7gCvtytf3CQisb6LSJA", "ane", // iOS 12.0–13.7
    ...
    "7NoMrNekLOY0QTFFKY3MUg", "RegionSupportsCinnamon", // iOS 12.0+
    "7Ukdmk/m0mDoIbgES+BgbQ", "Full6FeaturesCapability",
    "84iheBmhAmsxIlcxG4a0zA", "VideoStillsCapability", // iOS 8.4–14.3
    ...
    "A8aFtN08Oqt21846jqnftQ", "SiriGestureCapability", // iOS 8.4–14.3
    ...
    "BfEIy3W3t0Wxf7Hf7LEsAw", "PearlCameraCapability", // iOS 13.7–14.3
    "BfM9558OSUj9vu/OmyjLnw", "AssistantCapability",
    "BhXj+5n3+0HcPoSArDGX7g", "EffectiveSecurityMode", // iOS 8.4–13.7
    "bstETUHlPlCFu+l1GRvM0A", "TVOutCrossfadeCapability",
    "BstyjvaCtwqls0MfbkGTSg", "DisplayMirroringCapability", // iOS 8.4–14.3
    ...
    "cHla4KIe1wv0OvpRVrzy/w", "hide-non-default-apps", // iOS 8.4+
    "Cp9cxpL94276NKHivShdCg", "HomeScreenWallpaperCapability",
    "cqjRgfBVUDsi5vrXdQOcng", "OpenGLES3Capability",
    "drPpRw0Jmqcxv1XQPn/q/Q", "CameraFrontFlashCapability", // iOS 9.3–14.3
    "dvaktw5A/h0zlsWpMg/COQ", "DeviceSupports64Bit",
    "dZ2183tXAlFrXRtDcdiqJQ", "Peer2PeerCapability",
    "E2iZGHvwvi387UKi9wC2Mg", "CameraFlashCapability", // iOS 8.4–14.3
    "Ecx7M8v2wk05Fch3pFE/GA", "NikeIpodCapability", // iOS 8.4–14.3
    "eDiwRLHFAmDNNPtULAcEZA", "TelephonyMaximumGeneration",
    "ePAkIesI8SUJiAx8uRCcEA", "HDRImageCaptureCapability",
    "EPMipOaz6R549ljzQFXEkA", "VolumeButtonCapability", // iOS 17.0–26.0
    "fAwIjGT2efY3MHaGNHbCeQ", "modelIdentifier", // iOS 12.0–14.3
    "FfP+vxxGg5AbBO0uzmp6rw", "GasGaugeBatteryCapability",
    "FgjnMkPJPpI4C38dWETwtw", "flash", // iOS 10.3–13.7
    "Fralg2R4+pkggafylKbVgw", "HearingAidLowEnergyAudioCapability", // iOS 8.4–14.3
    ...
    "htWSrEg/cfn3squdzvER/w", "MLEHW", // iOS 9.3–14.3
    "hVVttq0KhS190K5SkaajpQ", "FrontFacingCameraCapability",
    "I2IvpG8yJdNpvO4csuB9EA", "LocationRemindersCapability", // iOS 8.4–14.3
    ...
    "jyEyRLza0L3StNXgFUCoTw", "GPSCapability", // iOS 12.0–14.3
    ...
    "kMHGt7N4hx12NopZFcIz6Q", "RingerSwitchCapability", // iOS 8.4–13.7
    "kTX3vfIkwQHB9e90qFxlDg", "PhotoStreamCapability",
    "KXulcwjWtgzrg+u8qILKBQ", "LocationServicesCapability",
    "ld2eewXs5StVwdRtwYT8sw", "PersonalHotspotCapability", // iOS 8.4–14.3
    ...
    "lM8BH5myz/qFGeIYnsiEoQ", "HearingAidAudioEqualizationCapability", // iOS 8.4–14.3
    ...
    "MulRZdIO3jyzkPar/CuDXA", "software-dimming-alpha", // iOS 8.4–14.3
    "MWJNrFKpHkBEm8jAdJf1xw", "AirplayMirroringCapability", // iOS 8.4–14.3
    "nfoN5DvniQJQRqNth7F0fg", "HMERefreshRateInARKit",
    "NnjMKIIAarYqUsQjrLAzCA", "avatar-camera", // iOS 17.0–26.0
    "nPGxu4rFOh+jGGPSoUFgwA", "DictationCapability",
    "nqZ6O+s733xoZqQZZ1NWRw", "AmbientLightSensorCapability",
    "NwAF2cQVdjOKc7KkqR9tIA", "GyroscopeCapability", // iOS 17.0–26.0
    ...
    "PUY/n3uJEk8GSE+RjkHHAA", "video-cap", // iOS 10.3–13.7
    ...
    "SBe5o/DMF5Z94MS+ZzmBCA", "DeviceSupportsNFC", // iOS 13.7–14.3
    "sgo5tedXL8Fn5rsAqD9yiQ", "HardwareEncodeSnapshotsCapability",
    "SjED0v6tcI1c4fqvuUYAqQ", "EffectiveProductionStatus", // iOS 8.4–13.7
    ...
    "U28TFcPMDYvyjIBpc8HZ4Q", "DeviceSupports3rdPartyHaptics", // iOS 13.7–14.3
    "Ue0GVAyEOkP5kyQgcXKlxg", NULL,
    "UKxn1HFRFlH0WCYlMr0gVg", "SimultaneousCallAndDataCurrentlySupported",
    "ulPs+OBjapRJaJ6Ech3OFA", "h264-encoder", // iOS 8.4–13.7
    ...
    "v5AoJC7hPGHbysTMLip12A", "SupportsTapToWake", // iOS 13.7–14.3
    "V5QFNbWGgrw+UZPvgIbDvQ", "ASTC", // iOS 12.0–14.3
    "VhcvUOAVhvIns8SosbTDrg", "NotGreenTeaDeviceCapability",
    "VOKmP/SJjhnx1AaT13J7QA", "MultitaskingGesturesCapability",
    "vwZ4ohiPF3w3M1jzHbP30g", "HallEffectSensorCapability", // iOS 8.4–13.7
    ...
    "XACgWnmwo1t6swUPu+/UUQ", "AutoFocusCameraCapability", // iOS 8.4–14.3
    ...
    "YH5LeF090QGZQTvT76qcBg", "HearingAidPowerReductionCapability", // iOS 8.4–14.3
    "YWQYAm8X1mwtoYPwpLF6YA", "YouTubePluginCapability",
    "z1AiZGX3Zz2qjXit83EHMA", "MultiTouchCapability", // iOS 17.0–26.0
    ...
    "zPSNnYDFk+x5ebOtenb3Eg", "auto-focus", // iOS 10.3–13.7
